package com.saoudi.ORM.util;

import com.saoudi.ORM.DatabaseManager;
...
public abstract class AbstractRepository<T extends Identifiable> implements InterfaceRepository<T> {
